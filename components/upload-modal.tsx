      ...
      <div className="bg-[#13151c] border border-white/[0.1] rounded-2xl w-full max-w-md max-h-[90dvh] flex flex-col shadow-2xl relative my-auto overflow-hidden">
        ...
        <div className="flex items-center justify-between px-4 sm:px-6 py-3.5 sm:py-4 border-b border-white/[0.06] shrink-0">
          ...
          <button
            ...
            className="p-1.5 rounded-lg text-slate-400 hover:text-white hover:bg-white/[0.06] transition-colors disabled:opacity-50 cursor-pointer"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        <div className="p-4 sm:p-6 space-y-4 overflow-y-auto">
          ...
          <div
            ...
            className={`border-2 border-dashed rounded-2xl p-6 sm:p-8 text-center cursor-pointer transition-all ${dragActive
                ? 'border-indigo-500 bg-indigo-950/20 shadow-md shadow-indigo-500/10'
                : 'border-white/[0.1] hover:border-indigo-500/40 bg-white/[0.02] hover:bg-white/[0.04]'
              }`}
          >
            <input
              ref={fileInputRef}
          ...
          <div className="flex items-center justify-end gap-2.5 pt-2">
            <button
              ...
              onClick={onClose}
              disabled={uploading || processing}
              className="px-4 py-2 rounded-full text-xs font-medium text-slate-400 hover:text-slate-200 hover:bg-white/[0.06] transition-colors disabled:opacity-50 cursor-pointer"
            >
              Cancel
            </button>
            <button
            ...
            >
              {(uploading || processing) && <Loader2 className="w-3.5 h-3.5 animate-spin" />}
